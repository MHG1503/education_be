...
public interface ExamResultRepository extends JpaRepository<ExamResultEntity, Long> {
    ...
    List<ExamResultEntity> findByUserId(@Param("userId") Long userId);

    // Lấy tất cả lần làm bài của user cho một exam cụ thể
    List<ExamResultEntity> findByUserIdAndExamId(@Param("userId") Long userId,
